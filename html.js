...
<html lang="en" with-selection-styled>
  <head>
    ...
    <meta property="og:url" content="http://127.0.0.1:8787">
    ...
    <meta name="twitter:url" content="http://127.0.0.1:8787">
  ...
  <body>
    <div class="Surface">
      <div class="Panel">
        <div class="Panel--top">
          <h1><a href="http://127.0.0.1:8787" class="Link Link-without-underline"><span class="WebScraperLogo"><span>web.scraper</span><span class="WebScraperLogo--muted">.workers.dev</span></span></a></h1>
        ...
        <main class="Panel--main" is-smooth-scrolling>
          <form id="form" class="Stack" method="GET" action="http://127.0.0.1:8787">
            ...
            <div class="FormField">
              ...
              <input class="Input" value="a" is-pristine id="selector" type="text" name="selector" pattern="(?:\\*|(?:[#.]?[a-zA-Z0-9_-])+)(?:\\[(?:\\S.*)=(?:\\S.*)\\])?(?::\\S*)?(?:(?:\\s+)?(?:,|>)?(?:\\s+)?(?:\\*|(?:\\.?[a-zA-Z0-9_-])+)(?:\\[(?:\\S.*)~?\\^?=(?:\\S.*)\\])?(?::\\S*)?)*" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required />
            </div>

            <div class="FormField">
              <div class="Radio---list">
                <div class="Radio">
                  <input class="Radio--input" type="radio" name="scrape" id="scrape-text" value="text"/>
                  <label class="Radio--label" for="scrape-text">Scrape the text contents of matched nodes</label>
                </div>
                <div class="Radio">
                  <input class="Radio--input" type="radio" name="scrape" id="scrape-attr" value="attr" checked/>
            ...
            <div class="FormField" show-if-scrape="attr" is-hidden>
              ...
              <input class="Input" value="href" is-pristine id="attr" type="text" name="attr" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"/>
            </div>
        ...
        <div class="Panel--bottom">
          <div class="Row">
            ...
            <a data-js-permalink href="http://127.0.0.1:8787" class="Button Button-is-bordered" type="button">Permalink</a>
          </div>
        </div>
      </div>
